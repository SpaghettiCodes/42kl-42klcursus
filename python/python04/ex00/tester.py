...
# # ft_statistics(1,2,3,4,5,6,7,8, toto="mean", tutu="median", tata="quartile")
# # ft_statistics(1,2,3,4,5,6, toto="mean", tutu="median", tata="quartile")
...
# print("-----")
# ft_statistics("ah", "yes", "broken", "input")

from statistics import ft_statistics
ft_statistics(42, 115, 30, 151, 6400, toto="mean",
              tutu="std", tata="quartile", titi="djdj")
print("-----")
