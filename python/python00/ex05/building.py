...
def get_statistics(string: str):
    ...
    Whitespaces
    The total punctuation symbols used (which is basically just [length - upper - lower - white])
...
def print_statistics(total_len, total_upper, total_lower, total_punctuations, total_spaces, total_digit):
    """
